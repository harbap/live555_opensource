...
COMPILE_OPTS =		$(INCLUDES) -I/usr/local/include -I/workdir/openssl/libc2.23/include -I. -O2 -DSOCKLEN_T=socklen_t -DNO_SSTREAM=1 -D_LARGEFILE_SOURCE=1 -D_FILE_OFFSET_BITS=64
C =			c
...
LIB_SUFFIX =			a
LIBS_FOR_CONSOLE_APPLICATION = -lssl -lcrypto -L/workdir/openssl/libc2.23/lib
...
app_install:
	cp ./testProgs/testOnDemandRTSPServer ../onDemande_app/ -f
